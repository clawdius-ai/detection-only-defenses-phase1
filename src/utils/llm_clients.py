...
def _read_dotenv_var(name: str) -> Optional[str]:
    """Read a variable from a project-local .env, taking precedence over the
    process environment. The .env file shipped alongside the repository is
    treated as the source of truth for credentials.
    """
...
class OpenAIChatClient:
    ...
    def __init__(self, model: str, api_key: Optional[str] = None,
        ...
        # Credential resolution priority: explicit arg > project .env > env var.
        if not api_key:
...
class OpenRouterChatClient:
    ...
    def __init__(self, model: str, api_key: Optional[str] = None,
                 ...
                 referer: str = "https://github.com/CyberScienceLab/Detection-only-Defenses-for-LLMs---Amine",
